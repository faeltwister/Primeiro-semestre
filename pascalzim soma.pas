...
Begin   								{<<<< abaixo está a cor do texto}
     ...
     read (numb2);    							{<<< Read (numb2) é a segunda variável do tipo inteiro que vai ser lido }
     soma:= (numb1+numb2);         					{<<< soma é o nome da variável do tipo inteiro ao qual vai ser somado o numero 1 e o numero 2 }
